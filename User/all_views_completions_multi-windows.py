# Original code: https://github.com/alienhard/SublimeAllAutocomplete (Copyright (C) 2013 Adrian Lienhard)
...
#
# hsandt's contribution:
# Customized to also match words from files in other active windows
# Adapted to Sublime Text 3 API
